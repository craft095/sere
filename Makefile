...
# source files
SERE_SRCS := \
    Language.cpp EvalSere.cpp Letter.cpp Z3.cpp Nfasl.cpp NfaslTests.cpp

SERE_TESTS_SRCS := \
    SereTests.cpp $(SERE_SRCS)

NFASL_TESTS_SRCS := \
    NfaslTests.cpp $(SERE_SRCS)
...
NFASL_TESTS_OBJS := $(patsubst %,$(OBJDIR)/%.o,$(basename $(NFASL_TESTS_SRCS)))
